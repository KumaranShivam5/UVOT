...
for filter_used in filters:
	...
	sys("mkdir analysis/output_files/"+filter_used+"/uvotsource")


	##...running uvotimsum on all

	for ids in obs_id:
		to_sys="uvotsource image=analysis/summed_images/"+filter_used+"/sum_img_"+ids+filter_used+".img outfile=analysis/output_files/"+filter_used+"/uvotsource/source_output_"+ids+filter_used+".fits srcreg=analysis/region_files/common/src.reg bkgreg=analysis/region_files/common/bg.reg sigma=3 apercorr=CURVEOFGROWTH"
		sys(to_sys)
